...
(function(){
    ...
    defineProperties(MaplatImageryProvider.prototype, {
        url : {
            get : function() {
                return this._url;
            }
    ...
    MaplatImageryProvider.prototype.getTileCredits = function(x, y, level) {
        return undefined;
    };

    MaplatImageryProvider.prototype.requestImage = function(x, y, level) {
        if (!this._ready) {
    ...
    MaplatImageryProvider.prototype.pickFeatures = function() {
        return undefined;
    };

    Cesium.MaplatImageryProvider = MaplatImageryProvider;
})();
